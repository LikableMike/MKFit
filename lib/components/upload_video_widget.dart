              ...
              children: [
                ...
                FFButtonWidget(
                  onPressed: () async {
                    ...
                    String destination =
                        "videos/exercises/${_model.textController.text}";
                    UploadTask? uploadTask =
                        await databaseService.uploadFile(file, destination);
                    if (uploadTask != null) {
                      TaskSnapshot taskSnapshot = await uploadTask;
                      String url = await taskSnapshot.ref.getDownloadURL();
                      databaseService.updateExercise(
                          "video_sample", _model.textController.text, url);
                    }
                    Navigator.pop(context);
                  },
                  text: 'Submit',
